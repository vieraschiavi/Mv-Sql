 ...
 * (web/index.html) lleva su propio I18N inline y su propia demo; los
 * únicos <script src> del sitio son purchase.js y seguro.js. Queda acá
 * como referencia de la versión anterior — si se lo va a resucitar,
 * pasar sus innerHTML por MvSqlSeguro antes de engancharlo a una página.
 */
...
function applyLang(lang) {
  ...
  document.querySelectorAll("[data-i18n]").forEach((el) => {
    ...
    // innerHTML [B] LITERAL: dict viene de I18N (assets/i18n.js), literales
    // de este repo con markup propio. Sin dato de usuario ni de la base.
...
function restartDemo() {
  ...
  // innerHTML [B] LITERAL: demo simulada, todo el HTML de acá abajo es
  // literal de este archivo y las interpolaciones son cadenas de I18N.
  // No hay resultados de una base real — esta demo no consulta nada.
  body.innerHTML = `
